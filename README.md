...
1. How would you explain form validation to someone who has never programmed before?
    ...
    Form validation is when a function alerts the user about a invalid field in the form    

1. In 1-2 sentences, define end to end testing.

    end to end testing is testing that mimics a user and asks 'can the user accomplish the action'
